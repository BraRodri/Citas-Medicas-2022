    ...
    <div class="col-md-4">
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="nameEmployed" value="" autocomplete="nameEmployed" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="nameCompany" value="" autocomplete="nameCompany" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="placeBirth" value="" autocomplete="placeBirth" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="dateBirth" value="" autocomplete="dateBirth" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="age" value="" autocomplete="age" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                <select id="statusCivil" class="form-control {{ $errors->has('statusCivil') ? 'is-invalid' : '' }}" name="statusCivil" required>
                    <option selected disabled>Selecciona</option>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="sons" value="" autocomplete="sons" placeholder="Escribe aquí" required>
    ...
    <div class="col-md-4">
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="address" value="" autocomplete="address" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="municipality" value="" autocomplete="municipality" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="phone" value="" autocomplete="phone" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="profession" value="" autocomplete="profession" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="ocupation" value="" autocomplete="ocupation" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="dateAdmission" value="" autocomplete="dateAdmission" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="seniorityCompany" value="" autocomplete="seniorityCompany" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="stratum" value="" autocomplete="stratum" placeholder="Escribe aquí" required>
    ...
    <div class="col-md-4">
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="dateExam" value="" autocomplete="dateExam" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                <select id="typeDocument" class="form-control {{ $errors->has('typeDocument') ? 'is-invalid' : '' }}" name="typeDocument" required>
                    <option selected disabled>Selecciona</option>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="document" value="" autocomplete="document" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="eps" value="" autocomplete="eps" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="afp" value="" autocomplete="afp" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="rh" value="" autocomplete="rh" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="scholarship" value="" autocomplete="scholarship" placeholder="Escribe aquí" required>
        ...
        <div class="row mt-2">
            ...
            <div class="col-md-6">
                ...
                name="areaWork" value="" autocomplete="areaWork" placeholder="Escribe aquí" required>
